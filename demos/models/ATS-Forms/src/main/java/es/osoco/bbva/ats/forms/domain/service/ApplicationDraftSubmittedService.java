...
public class ApplicationDraftSubmittedService extends AbstractApplicationSubmitService implements Consumer<ApplicationDraftSubmitted>  {

    @Override
    public void accept(ApplicationDraftSubmitted domainEvent) {
        ...
        new ApplicationDraftStored(application).emit();
    }
