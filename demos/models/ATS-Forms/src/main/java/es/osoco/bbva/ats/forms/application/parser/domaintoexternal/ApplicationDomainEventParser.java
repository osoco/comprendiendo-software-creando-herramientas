...
public class ApplicationDomainEventParser extends  CommonFormParser implements Parser<ApplicationDomainEvent> {

    public static ApplicationDomainEventParser getInstance() {
    ...
    protected static final class ApplicationDomainEventParserSingletonContainer {
        protected static final ApplicationDomainEventParser SINGLETON = new ApplicationDomainEventParser();
    }
