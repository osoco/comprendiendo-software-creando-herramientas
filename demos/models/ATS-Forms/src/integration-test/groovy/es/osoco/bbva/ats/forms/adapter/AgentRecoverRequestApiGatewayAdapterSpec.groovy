...
class AgentRecoverRequestApiGatewayAdapterSpec extends Specification {

    void 'test application recover request adapter with incorrect applicantKey'() {
        given: 'clean redis database'
        CleanRedisHelper.cleanRedis()
        CreateFixtureForm.createForm()

        and: 'a ApiGatewayAdapter instance'
        AgentRecoverRequestApiGatewayAdapter apiGatewayAdapter = new AgentRecoverRequestApiGatewayAdapter()

        and: 'form request input message'
        JsonApplicationRecoverRequested applicationRecoverRequest = new JsonApplicationRecoverRequested (
        ...
        when: 'api gateway adapter received a message by http'
    ...
    void 'test application recover request use case with correct applicantKey'() {
        ...
        DraftFormAnsweredApiGatewayAdapter draftFormApiGatewayAdapter = new DraftFormAnsweredApiGatewayAdapter()
