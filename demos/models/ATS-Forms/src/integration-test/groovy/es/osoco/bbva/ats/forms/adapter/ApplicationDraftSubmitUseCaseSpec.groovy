...
class ApplicationDraftSubmitUseCaseSpec extends Specification  {

    void 'test applicationSubmit draft form use case'() {
        given: 'a ApiGatewayAdapter instance'
        def apiGatewayAdapter = new DraftFormAnsweredApiGatewayAdapter()
    ...
    void 'test applicationSubmit draft form with contacts use case'() {
        given: 'a ApiGatewayAdapter instance'
        def apiGatewayAdapter = new DraftFormAnsweredApiGatewayAdapter()

        and: 'form answered input message with contacts section'
        def gson = new GsonBuilder().create();
        def formAnswered = gson.fromJson(formAnsweredJsonWithContacts, JsonFormAnswered.class);
    ...
    private final static formAnsweredJsonWithContacts = '''{
  "formId": "form-1",
  "contestId": "41c8e0aa-56a2-4ab0-a54b-86e93dee73fe",
  "title": "Open Talent 2017",
  "language": "es",
  "origin": "http://localhost:3000/",
  "sections": [
    {
      "sectionId": "1",
      "text": "Liderazgo",
      "helpText": "Incluye a continuación los curriculumns de los dos principales líderes.",
      "type": "multitab",
      "tabs": [
        {
          "text": "Lider 1",
          "questions": [
            ...
            },
            {
              ...
              "required": false,
              "type": "longtext",
              "text": "Funciones del líder 1 (máximo 300 caracteres)",
              "isValid": true,
              "focus": false
            }
          ]
        },
        {
          ...
          "questions": [
            ...
            },
            {
              ...
              "required": false,
              "type": "longtext",
              "text": "Funciones del líder 2 (máximo 300 caracteres)",
              "isValid": true,
              "focus": false
            }
          ]
    ...
    {
      "sectionId": "2",
      "text": "Your Personal Data and Team",
      "helpText": "Tus datos personales y los del resto de miembros del equipo.",
      "questions": [
        {
          "id": "13",
          "required": true,
  ...
  "answers": [
    ...
    {
      "questionId": "2",
      "text": "+34 660 66 06 60"
    },
    {
      "questionId": "3",
      "text": "funciones tradicionales"
    },
    {
      "questionId": "6",
      "text": "funciones futuras"
    },
    {
      "questionId": "13",
      "text": "victor"
    ...
    {
      "questionId": "16",
      "text": "victor.delvalle@osoco.es"
    },
    {
      "questionId": "15",
      "text": "2017-07-03T22:00:00.000Z"
    }
  ]
}'''
