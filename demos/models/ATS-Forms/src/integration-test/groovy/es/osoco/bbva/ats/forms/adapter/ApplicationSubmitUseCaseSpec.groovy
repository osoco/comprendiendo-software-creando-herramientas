...
class ApplicationSubmitUseCaseSpec extends Specification {


    void 'test applicationSubmit complete form use case'() {
        ...
        def apiGatewayAdapter = new FormAnsweredApiGatewayAdapter()
