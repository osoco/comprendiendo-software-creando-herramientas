...
class ApplicationUpdateUseCaseSpec extends Specification {


    void 'test applicationUpdate form use case'() {
        given: 'clean redis database'
        CleanRedisHelper.cleanRedis()
        CreateFixtureForm.createForm()

        and: 'a ApiGatewayAdapter instance'
        def apiGatewayAdapter = new UpdateApplicationApiGatewayAdapter()
        ...
        JsonFormAnswered draftFormAnswered = gson.fromJson(formAnsweredJson, JsonFormAnswered.class);
        draftFormapiGatewayAdapter.handleRequest(draftFormAnswered, context);
